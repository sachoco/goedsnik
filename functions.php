...
add_action('admin_head', 'add_br_button');
function add_br_button() {
    global $typenow;
    ...
    if ( get_user_option('rich_editing') == 'true') {
        add_filter("mce_external_plugins", "add_br_plugin");
        add_filter('mce_buttons', 'register_br_button');
    }
}
function add_br_plugin($plugin_array) {
    $plugin_array['br_button'] = get_template_directory_uri() . '/tinymce/br.js';
    return $plugin_array;
}
function register_br_button($buttons) {
   array_push($buttons, "br_button");
   return $buttons;
}
